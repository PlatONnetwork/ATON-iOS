...
#import "UITextField+AspectsScaling.h"
#import <objc/runtime.h>

@implementation UITextField (AspectsScaling)
...
- (instancetype)initWithCoderX:(NSCoder *)aDecoder {
    ...
    if (self) {
        ...
        self.font = [UIFont systemFontOfSize:self.font.pointSize*ratio];
    }
    return self;
}
