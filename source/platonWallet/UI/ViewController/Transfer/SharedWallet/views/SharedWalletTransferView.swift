...
class SharedWalletTransferView : UIView{
    ...
    @IBOutlet weak var toAddressTipTopConstraint: NSLayoutConstraint!
    ...
    @IBOutlet weak var memoTipTopConstraint: NSLayoutConstraint!
    ...
    func initSubViews() {
        ...
        self.toAddressTipTopConstraint.constant = 0
        self.memoTipTopConstraint.constant = 0
    ...
    func checkInputAddress(showTip : Bool) -> Bool{
        ...
        if showTip && !valid{
            UIView.animate(withDuration: 0.3) {
                ...
                self.toAddressTipTopConstraint.constant = 6
                self.layoutIfNeeded()
            }
        }else{
            UIView.animate(withDuration: 0.3) {
