...
open class ButtonBarView: UICollectionView {
    ...
    var selectedBarZPosition: CGFloat = 0 {
        didSet {
            selectedBar.layer.zPosition = selectedBarZPosition
        }
    }
    ...
    var selectedIndex = 0
    var selectedBarLayerCorner: CGFloat = 0.0
    ...
    open func move(fromIndex: Int, toIndex: Int, progressPercentage: CGFloat, pagerScroll: PagerScroll) {
        ...
        selectedBar.frame = CGRect(x: targetFrame.origin.x, y: selectedBar.frame.origin.y, width: selectedBarWidth ?? targetFrame.size.width, height: selectedBar.frame.size.height)
    ...
    open func updateSelectedBarPosition(_ animated: Bool, swipeDirection: SwipeDirection, pagerScroll: PagerScroll) {
        ...
        selectedBarFrame.size.width = selectedBarWidth ?? selectedCellFrame.size.width
    ...
    private func updateSelectedBarYPosition() {
        ...
        selectedBar.frame = selectedBarFrame
        selectedBar.layer.cornerRadius = selectedBarLayerCorner
    }
