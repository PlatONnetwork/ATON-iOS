//
//  PTSButtonBarPagerTabStripViewController.swift
//  platonWallet
//
...
public struct ButtonBarPagerTabStripSettings {
    ...
    public struct Style {
        ...
        public var selectedBarLayerCorner: CGFloat = 0.0
...
class ButtonBarPagerTabStripViewController: PagerTabStripViewController, PagerTabStripDataSource, PagerTabStripIsProgressiveDelegate, UICollectionViewDelegate, UICollectionViewDataSource {
    
    public var settings = ButtonBarPagerTabStripSettings()
    
    public var buttonBarItemSpec: ButtonBarItemSpec<PTSButtonCell>!
    
    public var changeCurrentIndex: ((_ oldCell: PTSButtonCell?, _ newCell: PTSButtonCell?, _ animated: Bool) -> Void)?
    public var changeCurrentIndexProgressive: ((_ oldCell: PTSButtonCell?, _ newCell: PTSButtonCell?, _ progressPercentage: CGFloat, _ changeCurrentIndex: Bool, _ animated: Bool) -> Void)?
    ...
    open override func viewDidLoad() {
        ...
        buttonBarItemSpec = .nibFile(nibName: "PTSButtonCell", bundle: bundle, width: { [weak self] (childItemInfo) -> CGFloat in
            let label = UILabel()
...
//            label.text = childItemInfo.title
        ...
        buttonBarView.selectedBarLayerCorner = settings.style.selectedBarLayerCorner
        buttonBarView.selectedBarZPosition = settings.style.selectedBarZPostion
        ...
        case .cellClass:
            buttonBarView.register(PTSButtonCell.self, forCellWithReuseIdentifier:"Cell")
        }
        //-
    }
    ...
    private func cellForItems(at indexPaths: [IndexPath], reloadIfNotVisible reload: Bool = true) -> [PTSButtonCell?] {
        let cells = indexPaths.map { buttonBarView.cellForItem(at: $0) as? PTSButtonCell }
    ...
    open func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "Cell", for: indexPath) as? PTSButtonCell else {
...
//        cell.label.text = indicatorInfo.title
    ...
    open func configureCell(_ cell: PTSButtonCell, indicatorInfo: IndicatorInfo) {
    }
